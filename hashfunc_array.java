...
public class hashfunc_array {
	...
	public static void main(String[] args) {
		...
		hashfunc_array theFunc = new hashfunc_array(31);
		...
		theFunc.hashfunc_array(elementsToAdd2, theFunc.theArray);
	...
	public void moveOldArray(int newArraySize) {
		...
		hashfunc_array(cleanArray, theArray);
	...
	public void hashfunc_array(String[] stringsForArray, String[] theArray) {
