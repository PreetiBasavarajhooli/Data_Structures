public class Link {
	...
	public static void main(String[] args) {
		...
		theLinkedList.insertFirstLink("Preeti", 500);
		theLinkedList.insertFirstLink("Basavaraj", 200);
		theLinkedList.insertFirstLink("Hooli", 150);
		theLinkedList.insertFirstLink("ComputerScience", 107);
